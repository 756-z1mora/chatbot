...
class ResultView extends StatefulWidget {
  final List<int>? answers; // Acepta una lista de enteros como argumentos

  ResultView({this.answers});
...
void initState() {
  ...
  if (widget.answers != null) {
    ...
    print('No hay argumentos válidos');
    _diagnosisFuture = Future.error("Los argumentos no son válidos");
  }
}
...
Map<String, String> _parseDiagnosis(String diagnosis) {
  if (diagnosis.isEmpty) {
    return {}; // Retorna un mapa vacío si no hay diagnóstico
  }
